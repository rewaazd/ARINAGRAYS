...
let options = {
    ...
    let elements3 = document.querySelectorAll('.first-photos-projects');
    let observer4 = new IntersectionObserver(onEntry, options);
    let elements4 = document.querySelectorAll('.second-photos-projects');
    let observer5 = new IntersectionObserver(onEntry, options);
    let elements5 = document.querySelectorAll('.third-photos-projects');
    ...
    for (let elm of elements4) {observer4.observe(elm);}
    for (let elm of elements5) {observer5.observe(elm);}
