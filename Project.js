...
document.getElementById("open-modal-btn-6-6").addEventListener("click", function() {
  document.getElementById("my-modal-6").classList.add("open")
  document.body.classList.add('body-hidden');
  
})
document.getElementById("open-modal-btn-6-6-h3").addEventListener("click", function() {
  document.getElementById("my-modal-6").classList.add("open")
  document.body.classList.add('body-hidden');
  
})

document.getElementById("btn-close-6").addEventListener("click", function() {
...
document.querySelector("#my-modal-6 .modal-window-6").addEventListener("click", event => {
  event._isClickWithInModal = true;
});
